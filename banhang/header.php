        ...
        <nav class="navbar navbar-default" style="background: #F3EADA">
            <div class="container-fluid">
                <div class="navbar-header"style="margin-top: 5px; margin-left: 5px; >
                    <a style="color: red">CỬA HÀNG CHÚNG TÔI XIN HÂN HẠNH ĐƯỢC PHỤC VỤ QUÝ KHÁCH...</a>
                </div>
        ...
        <div id="header" style="background: #5c8d89; height: 100px">
            <div class="container">
                <div class="row" id="header-main">
                    <div class="col-md-2">
                        <a href="index.php">
                        <img src="public/frontend/images/header.PNG">
                        </a>
                    </div>
                    ...
                    <div class="col-md-2" id="header-right">
                        <div class="pull-right">
                            ...
                            <div class="pull-right">
                                ...
                                <p style="color: #fff"> 0985042190</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="https://ahachat.com/customer-chats/customer_chat_idbFR2gKIs626b6e8192bee.js"></script>
            ...
            <div class="box-left box-menu">
                ...
                <ul>
                      ...
                      <div class="panel-body"><p><span class="glyphicon glyphicon-map-marker"></span> Bến Lức, Long An</p></div>
                     <div class="panel-body"> <p><span class="glyphicon glyphicon-phone"></span> Phone: 0926600090</p></div>
                      <div class="panel-body"><p><span class="glyphicon glyphicon-envelope"></span> Email: voquoctuan090901hiie@gmail.com</p> 
                    </div>
                </ul>
                <!-- </marquee> -->
            </div>
