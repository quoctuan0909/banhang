<?php include_once'../autoload/autoload.php'; 
    ...
    $sql=" SELECT * FROM transaction WHERE status = 1 AND huy = 0 ORDER BY id DESC";
    $don = $db->fetchsql($sql);
    $totala = count($don);
    //phân trang
    if(isset($_GET['page']))
...
<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-file"></i> Đơn hàng đã xử lý
            </li>
        </ol>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                               ...
                               <li>Họ tên: <?php echo $users['account'];?></li>
                        ...
                        <td><b><?php echo formatprice(($row['amount']/95*100)/20) ?></b></td>
                        ...
                        <td>
                            ...
                            <a  href="in.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-success"><i class="fa fa-refresh" style="color: #fff;"></i> In hóa đơn</a>
