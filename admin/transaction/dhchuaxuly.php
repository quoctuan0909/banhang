                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                ...
                                <li>Thời gian: <?php echo $row['update_at'];?></li>
                            </ul>
                        </td>
                        ...
                        <td>
                            ...
                            <a style="margin-top: 5px;" href="in.php?id=<?php echo $row['id'] ?>" class="btn btn-xs btn-success"><i class="fa fa-refresh" style="color: #fff;"></i> In hóa đơn</a>
