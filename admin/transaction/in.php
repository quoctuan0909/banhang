...
<div id="page" class="page">
    <div class="header">
        <div ><p style="font-size: 25px; color: greenyellow;"><b>TTK STORE  </p></b> </div>
        <div class="company">
  ...
  <div class="footer-left"> <?php echo "Long An, ngày ".$date['mday']." tháng ".$date['mon']. " năm ".$date['year'] ?> <br/>
    Khách hàng <br/><p style="font-size: 16px;"><b><?php echo $user['account']; ?></b></p>
</div>
  <div class="footer-right"> <?php echo "Long An, ngày ".$date['mday']." tháng ".$date['mon']. " năm ".$date['year'] ?> <br/>
    Chủ cửa hàng <br/>  <p style="font-size: 16px;"><b><?php echo "TTK STORE"; ?></b></p>
</div>
