...
//session_start();
  ...
  $id = intval(getInput('id'));
    ...
    if(!isset($_SESSION['name_id'])){
        ...
        $user = $db->fetchID("users",intval($_SESSION['id']));
...
<body>
    ...
    <nav style="background-color: royalblue;height: 30px;" class="navbar navbar-expand-lg navbar-dark ">
        <div class="container">
             <a class="navbar-brand" href="index.php" style="margin-top: 20px;"><i class="fa fa-sdt" aria-hidden="true"></i>LIÊN HỆ: 0985042190</a>
    ...
    <!-- header -->
        ...
        <div class="row">
            ...
            <form class="form-horizontal" action="xulithanhtoan.php" method="POST">
            <div class="form-group" style="margin-left: 50px;margin-top: -20px;"  >
            <label class="control-label col-sm-4" style="text-align: left" for="account">Tên khách hàng:</label>
        ...
        <div class="col-sm-10">
            ...
            <div class="col-md-5 ">
                ...
                <form action="xulithanhtoan.php" id="create_form" method="post">
                  ...
                  <input class="form-control"  type="hidden" name="order_id" value="<?php echo $key?>">
                   <?php endforeach ?>
                    </div>
                    </div>     
