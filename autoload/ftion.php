<?php 
    ...
    **/
    ...
    $nFrom = 'Thanh Dũ';
    $mFrom = 'thanhduthpt@gmail.com';  //dia chi email cua ban 
    $mPass = 'tkientink751';       //mat khau email cua ban
    $mail             = new PHPMailer();
    $body             = $content;
    $mail->IsSMTP(); 
    $mail->CharSet   = "utf-8";
    ...
    $mail->AddReplyTo('thanhduthpt@gmail.com', 'Dũ');
    if(!$mail->Send()) {
        return 0;
    } else {
        return 1;
...
function sendMailAttachment($title, $content, $nTo, $mTo,$diachicc='',$file,$filename){
    ...
    $address = $mTo;
    $mail->AddAddress($address, $nTo);
    $mail->AddReplyTo('thanhduthpt.com', 'Dũ');
